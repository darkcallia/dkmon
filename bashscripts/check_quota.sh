...
#
#Добавлен подсчет траффика между РО и Ф1
#Добавлено 20.02.2017 - чтение свободного места на 10.51.0.203
#Добавлено 31.01.2017 - чтение свободного места на ПК Ф1 SpRecord 10.51.1.205
#Добавлено 31.01.2017 - чтение свободного места массива 0.209 через самбу
#Добавлено 28.12.2016 - читает файл result.txt с сервера 10.51.0.203 со списком пользователей файл сервера превысивших квоту
#удаляет лишнюю информацию
#-------------------------------------
#Файл result.txt с сервера 10.51.0.203
#переходим в каталог
cd /home/shared/
