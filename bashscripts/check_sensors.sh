#!/bin/bash
#Сбор данных с датчиков через плату arduino подключенной к сети. Сохраниние собранных данных в лог
#darkcallia
#v2017.01.23
#Сообщает на почту и на страницу check.php о срабатывании датчиков
